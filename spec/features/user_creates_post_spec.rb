...
RSpec.describe "Creating post" do
  let(:user) { User.create(username: "exempleuser", email: "exemple@user.com", password: "password", password_confirmation: "password")}
  ...
  scenario "successfully" do
    ...
    within(".posts") do
      ...
      expect(page).to have_content "exempleuser"
    end
  end
